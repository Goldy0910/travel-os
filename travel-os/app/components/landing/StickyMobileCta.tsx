...
export default function StickyMobileCta() {
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-40 flex justify-center px-4 pb-[max(0.75rem,env(safe-area-inset-bottom))] pt-2 md:hidden">
      <div className="pointer-events-auto min-w-0 w-full max-w-md overflow-hidden rounded-t-2xl border border-b-0 border-slate-200 bg-white/95 p-4 shadow-[0_-12px_40px_rgba(0,0,0,0.08)] backdrop-blur-md">
        <LandingLink
          href="/app/login"
