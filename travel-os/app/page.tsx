...
export default function HomePage() {
  return (
    <PublicShell footer={<StickyMobileCta />}>
        ...
        <main className="flex-1 overflow-y-auto overscroll-y-contain [-webkit-overflow-scrolling:touch] pb-28 md:pb-16">
          {/* Hero */}
          <section className="relative overflow-hidden px-4 pb-10 pt-6 md:px-10 md:pb-16 md:pt-12">
            <div
            ...
            <div className="relative mx-auto max-w-3xl text-center md:max-w-4xl">
              ...
              <h1 className="mt-2 text-[1.65rem] font-bold leading-[1.2] tracking-tight text-slate-900 md:text-4xl md:leading-tight">
                All your travel plans. Finally in one place.
              </h1>
              <p className="mt-4 text-[0.9375rem] leading-relaxed text-slate-600 md:mx-auto md:max-w-2xl md:text-lg">
                Stop juggling WhatsApp chats, PDFs, and notes. Manage your
                entire trip in one simple app.
              </p>
              <div className="mt-7 flex w-full flex-col gap-3 md:mx-auto md:max-w-md md:flex-row md:justify-center">
                <LandingLink
                  href="/app/login"
                  className="inline-flex min-h-[3rem] w-full items-center justify-center rounded-2xl bg-slate-900 px-6 py-3 text-base font-semibold text-white shadow-lg transition active:scale-[0.98] touch-manipulation md:w-auto md:min-w-[12rem]"
                >
                  Start your trip
                </LandingLink>
                <div className="rounded-2xl border border-teal-100 bg-gradient-to-br from-teal-50/80 to-white px-4 py-4 text-left shadow-sm md:flex md:min-w-[16rem] md:flex-col md:justify-center">
                  ...
                  <LandingLink
                    ...
                    className="mt-3 inline-flex min-h-11 w-full items-center justify-center rounded-xl border border-slate-200 bg-white px-4 text-sm font-semibold text-slate-900 transition active:scale-[0.98] touch-manipulation"
                  >
                    Find My Destination
                  </LandingLink>
                </div>
          ...
          {/* Problem → Solution — single column on mobile, two-up on web */}
          <section className="border-y border-slate-100 bg-slate-50/90 px-4 py-10 md:px-10 md:py-14">
            <div className="mx-auto max-w-5xl md:grid md:grid-cols-2 md:gap-10 md:items-start">
            <div>
            ...
            <div className="mt-6 rounded-2xl border border-teal-100 bg-gradient-to-br from-teal-50 to-white p-5 shadow-md md:mt-0">
          ...
          <section className="px-4 py-10 md:px-10 md:py-14">
            <div className="mx-auto max-w-5xl text-center">
              ...
              <p className="mt-2 text-sm leading-relaxed text-slate-600 md:mx-auto md:max-w-2xl">
                Not another generic planner—tools for life after you hit
                “confirm booking.”
              </p>
            </div>
            <div className="mx-auto mt-6 flex max-w-5xl flex-col gap-3 md:grid md:grid-cols-2 md:gap-4 lg:grid-cols-4">
              {features.map((f) => (
                <article
                  key={f.title}
          ...
          {/* How it works */}
          <section className="border-t border-slate-100 bg-slate-50 px-4 py-10 md:px-10 md:py-14">
            <h2 className="text-center text-xl font-bold tracking-tight text-slate-900 md:text-2xl">
              How it works
            </h2>
            <div className="mx-auto mt-6 flex max-w-5xl flex-col gap-4 md:grid md:grid-cols-3 md:gap-5">
              {steps.map((s) => (
                <div
                  key={s.n}
          ...
          {/* Preview */}
          <section id="preview" className="scroll-mt-4 px-4 py-10 md:px-10 md:py-14">
            <div className="mx-auto max-w-5xl text-center">
              <h2 className="text-xl font-bold tracking-tight text-slate-900 md:text-2xl">
                Inside the app
              </h2>
            ...
            <div className="mx-auto mt-6 max-w-5xl -mx-4 flex snap-x snap-mandatory gap-4 overflow-x-auto px-4 pb-2 md:mx-auto md:grid md:grid-cols-3 md:overflow-visible md:px-0 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden md:[&::-webkit-scrollbar]:hidden">
              {[
                {
                  label: "Home",
                ...
                <div
                  key={mock.label}
                  className="w-[72%] max-w-[200px] shrink-0 snap-center rounded-[1.75rem] border-[3px] border-slate-800 bg-slate-900 p-1.5 shadow-xl md:w-full md:max-w-none"
                >
          ...
          {/* Final CTA */}
          <section className="px-4 pb-6 md:px-10 md:pb-12">
            <div className="relative mx-auto max-w-3xl overflow-hidden rounded-2xl bg-gradient-to-br from-slate-900 via-slate-800 to-teal-900 px-5 py-10 text-center shadow-lg md:px-10 md:py-14">
              <div
              ...
              <p className="relative mt-2 text-xs text-slate-300 md:text-sm">
                Free to try. No credit card required.
              </p>
              <LandingLink
                href="/app/create-trip"
                prefetch={false}
                className="relative mt-6 inline-flex min-h-12 w-full items-center justify-center rounded-2xl bg-white px-6 py-3 text-base font-semibold text-slate-900 shadow-md transition active:scale-[0.98] touch-manipulation md:mx-auto md:max-w-xs"
              >
                Create trip
              </LandingLink>
            </div>
